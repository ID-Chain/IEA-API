"""
Django settings for identitychain_agent project.
...
SECRET_KEY = '2^ldzi@13m#mq*bp8t4=2hdph9+ndr#c@wx(_8a)=kikv-palj'
...
ROOT_URLCONF = 'identitychain_agent.urls'
...
WSGI_APPLICATION = 'identitychain_agent.wsgi.application'
